...
public class GenerateProcessorImpl implements GenerateProcessor {
    ...
    public GeneratingResult generate(String condition) {
        ...
        String generatedVariantInJson = JacksonHelper.toJson(variant);

        Solution ourSolution = new Solution(variant);
        String solutionInJson = JacksonHelper.toJson(ourSolution);
        return new GeneratingResult("Найдите значение сигнала на каждом слое сети и посчитайте MSE на выходном слое",
                generatedVariantInJson, solutionInJson);
    }
